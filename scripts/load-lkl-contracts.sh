...
if [ ! -z "$1" ] && [ $1="local" ]; then
    ...
    git clone https://github.com/LocklessFinance/lkl-protocol
    cd lkl-protocol/
    # load the balancer-v2 contracts which are gitignored in the lkl-contracts repo
...
cp -R lkl-protocol/contracts src
