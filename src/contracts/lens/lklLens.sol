...
contract lklLens{
    ...
    function getPoolDetails(ICCPool pool) public view returns(poolDetails memory poolInfo) {
    ...
    function calculateSwap(
        ...
        uint256 baseReserves = _normalize(poolInfo.baseReserves, poolInfo.tokenDecimals, 18);
        uint256 bondReserves = _normalize(poolInfo.bondReserves, poolInfo.tokenDecimals, 18) + 
    ...
    function getYieldExponent(uint256 expiration, uint256 unitSeconds) public view virtual returns (uint256) {
        // The fractional time
