...
export interface TrancheInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "incentiveRewards", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "incentiveRewards", data: BytesLike): Result;
...
export interface Tranche extends BaseContract {
    ...
    callStatic: {
        ...
        unlockTimestamp(overrides?: CallOverrides): Promise<BigNumber>;
        valueSupplied(overrides?: CallOverrides): Promise<BigNumber>;
        withdrawInterest(_amount: BigNumberish, _destination: string, overrides?: CallOverrides): Promise<[BigNumber, BigNumber]>;
